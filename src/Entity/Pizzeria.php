...
class Pizzeria
{
    ...
    /**
     * @var Collection
     * Unidirectional relation beetween Pizzerias and Pizzas (ManyToMany)
     * 
     * @ORM\ManyToMany(targetEntity="Pizza")
     * @ORM\JoinTable(name="pizzerias_pizzas",joinColumns={@ORM\JoinColumn(name="pizzeria_id", referencedColumnName="id_pizzeria")},
    ...
    /**
     * @var Collection
     * Bidirectional relation beetween Pizzeria and Pizzaiolo (OneToMany)
     * 
     * @ORM\OneToMany(targetEntity="Pizzaiolo", mappedBy="employeur")
     */
