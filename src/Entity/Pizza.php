...
class Pizza
{
    ...
    /**
     * @var Collection
     * Unidirectional relation beetween Pizzas and Ingredients(ManyToMany)
     * 
     * @ORM\ManyToMany(targetEntity="App\Entity\IngredientPizza")
     * @ORM\JoinTable(name="ingredients_pizzas", joinColumns={@ORM\JoinColumn(name="pizza_id", referencedColumnName="id_pizza")},
